//===- RISCV64SEISelLowering.h - RISCV64SE DAG Lowering Interface -----*- C++ -*-===//
//
...
class TargetRegisterClass;
  ...
  class RISCV64SETargetLowering : public RISCV64TargetLowering  {
  public:
    explicit RISCV64SETargetLowering(const RISCV64TargetMachine &TM,
