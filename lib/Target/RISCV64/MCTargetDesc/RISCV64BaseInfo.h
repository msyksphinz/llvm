//===-- RISCV64BaseInfo.h - Top level definitions for MIPS MC ------*- C++ -*-===//
//
...
/// RISCV64II - This namespace holds all of the target specific flags that
...
namespace RISCV64II {
  ...
  enum TOF {
    //===------------------------------------------------------------------===//
    // RISCV64 Specific MachineOperand flags.
