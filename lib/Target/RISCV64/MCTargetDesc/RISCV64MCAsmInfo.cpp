//===-- RISCV64MCAsmInfo.cpp - RISCV64 Asm Properties ---------------------------===//
//
...
//===----------------------------------------------------------------------===//
//
// This file contains the declarations of the RISCV64MCAsmInfo properties.
//
//===----------------------------------------------------------------------===//
...
void RISCV64MCAsmInfo::anchor() { }

RISCV64MCAsmInfo::RISCV64MCAsmInfo(const Triple &TheTriple) {
