//===- RISCV64ELFStreamer.h - ELF Object Output --------------------*- C++ -*-===//
//
...
class RISCV64ELFStreamer : public MCELFStreamer {
  SmallVector<std::unique_ptr<RISCV64OptionRecord>, 8> RISCV64OptionRecords;
  RISCV64RegInfoRecord *RegInfoRecord;
  SmallVector<MCSymbol*, 4> Labels;

public:
  RISCV64ELFStreamer(MCContext &Context, std::unique_ptr<MCAsmBackend> MAB,
  ...
  void EmitRISCV64OptionRecords();

  /// Mark labels as microMIPS, if necessary for the subtarget.
  void createPendingLabelRelocs();
};

MCELFStreamer *createRISCV64ELFStreamer(MCContext &Context,
