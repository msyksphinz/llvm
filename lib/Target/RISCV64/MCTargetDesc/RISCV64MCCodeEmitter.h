//===- RISCV64MCCodeEmitter.h - Convert RISCV64 Code to Machine Code --*- C++ -*-===//
//
...
//===----------------------------------------------------------------------===//
//
// This file defines the RISCV64MCCodeEmitter class.
//
//===----------------------------------------------------------------------===//
...
class RISCV64MCCodeEmitter : public MCCodeEmitter {
  const MCInstrInfo &MCII;
  MCContext &Ctx;
  bool IsLittleEndian;

  bool isMicroRISCV64(const MCSubtargetInfo &STI) const;
  bool isRISCV6432r6(const MCSubtargetInfo &STI) const;

public:
  RISCV64MCCodeEmitter(const MCInstrInfo &mcii, MCContext &Ctx_, bool IsLittle)
      : MCII(mcii), Ctx(Ctx_), IsLittleEndian(IsLittle) {}
  RISCV64MCCodeEmitter(const RISCV64MCCodeEmitter &) = delete;
  RISCV64MCCodeEmitter &operator=(const RISCV64MCCodeEmitter &) = delete;
  ~RISCV64MCCodeEmitter() override = default;
