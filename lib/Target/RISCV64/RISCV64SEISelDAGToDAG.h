//===-- RISCV64SEISelDAGToDAG.h - A Dag to Dag Inst Selector for RISCV64SE -----===//
//
...
class RISCV64SEDAGToDAGISel : public RISCV64DAGToDAGISel {

public:
  explicit RISCV64SEDAGToDAGISel(RISCV64TargetMachine &TM, CodeGenOpt::Level OL)
...
FunctionPass *createRISCV64SEISelDag(RISCV64TargetMachine &TM,
