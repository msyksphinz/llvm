//===- RISCV6416InstrInfo.h - RISCV6416 Instruction Information -------*- C++ -*-===//
//
...
class RISCV6416InstrInfo : public RISCV64InstrInfo {
  const RISCV6416RegisterInfo RI;

public:
  explicit RISCV6416InstrInfo(const RISCV64Subtarget &STI);
