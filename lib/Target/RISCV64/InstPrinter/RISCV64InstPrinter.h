//=== RISCV64InstPrinter.h - Convert RISCV64 MCInst to assembly syntax -*- C++ -*-==//
//
...
//===----------------------------------------------------------------------===//
//
// This class prints a RISCV64 MCInst to a .s file.
//
//===----------------------------------------------------------------------===//
...
namespace llvm {
// These enumeration declarations were originally in RISCV64InstrInfo.h but
// had to be moved here to avoid circular dependencies between
// LLVMRISCV64CodeGen and LLVMRISCV64AsmPrinter.
namespace RISCV64 {
// RISCV64 Branch Codes
enum FPBranchCode {
  BRANCH_F,
  BRANCH_T,
  BRANCH_FL,
...
const char *RISCV64FCCToString(RISCV64::CondCode CC);
} // end namespace RISCV64

class RISCV64InstPrinter : public MCInstPrinter {
public:
  RISCV64InstPrinter(const MCAsmInfo &MAI, const MCInstrInfo &MII,
