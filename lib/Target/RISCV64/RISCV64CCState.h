//===---- RISCV64CCState.h - CCState with RISCV64 specific extensions -----------===//
//
...
class RISCV64CCState : public CCState {
public:
  enum SpecialCallingConvType { RISCV6416RetHelperConv, NoSpecialCallingConv };
...
private:
  ...
  /// this for use by RetCC_RISCV64N.
...
public:
  RISCV64CCState(CallingConv::ID CC, bool isVarArg, MachineFunction &MF,
