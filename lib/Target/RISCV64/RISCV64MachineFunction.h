//===- RISCV64MachineFunctionInfo.h - Private data used for RISCV64 ---*- C++ -*-===//
//
...
//===----------------------------------------------------------------------===//
//
// This file declares the RISCV64 specific subclass of MachineFunctionInfo.
//
//===----------------------------------------------------------------------===//
...
/// RISCV64FunctionInfo - This class is derived from MachineFunction private
/// RISCV64 target-specific information for each MachineFunction.
class RISCV64FunctionInfo : public MachineFunctionInfo {
public:
  RISCV64FunctionInfo(MachineFunction &MF) : MF(MF) {}

  ~RISCV64FunctionInfo() override;
