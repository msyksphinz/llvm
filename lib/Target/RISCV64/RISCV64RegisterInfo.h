//===- RISCV64RegisterInfo.h - RISCV64 Register Information Impl ------*- C++ -*-===//
//
...
//===----------------------------------------------------------------------===//
//
// This file contains the RISCV64 implementation of the TargetRegisterInfo class.
//
//===----------------------------------------------------------------------===//
...
class RISCV64RegisterInfo : public RISCV64GenRegisterInfo {
public:
  enum class RISCV64PtrClass {
  ...
  static const uint32_t *getRISCV6416RetHelperMask();
