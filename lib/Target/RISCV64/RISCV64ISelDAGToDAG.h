//===---- RISCV64ISelDAGToDAG.h - A Dag to Dag Inst Selector for RISCV64 --------===//
//
...
class RISCV64DAGToDAGISel : public SelectionDAGISel {
public:
  explicit RISCV64DAGToDAGISel(RISCV64TargetMachine &TM, CodeGenOpt::Level OL)
...
protected:
  ...
  /// Keep a pointer to the RISCV64Subtarget around so that we can make the right
  /// decision when generating code for different targets.
  const RISCV64Subtarget *Subtarget;

private:
  // Include the pieces autogenerated from the target description.
  #include "RISCV64GenDAGISel.inc"
