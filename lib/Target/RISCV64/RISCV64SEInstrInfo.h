//===-- RISCV64SEInstrInfo.h - RISCV6432/64 Instruction Information ---*- C++ -*-===//
//
...
class RISCV64SEInstrInfo : public RISCV64InstrInfo {
  const RISCV64SERegisterInfo RI;

public:
  explicit RISCV64SEInstrInfo(const RISCV64Subtarget &STI);
...
private:
  ...
  void expandExtractElementF64(MachineBasicBlock &MBB,
                               MachineBasicBlock::iterator I, bool isMicroRISCV64,
                               bool FP64) const;
