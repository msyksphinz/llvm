...
//===----------------------------------------------------------------------===//
//
// Subclass of MYRISCVXTargetLowering specialized for cpu032.
//
//===----------------------------------------------------------------------===//
...
static cl::opt<bool>
EnableMYRISCVXTailCalls("enable-cpu0-tail-calls", cl::Hidden,
...
//@MYRISCVXSETargetLowering body {
  ...
  addRegisterClass(MVT::i32, &MYRISCVX::CPURegsRegClass);
