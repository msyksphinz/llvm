...
void MYRISCVXAnalyzeImmediate::GetInstSeqLsADDiu(uint64_t Imm, unsigned RemSize,
                                             InstSeqLs &SeqLs) {
...
// are replaced with
//  LUi 0x444
void MYRISCVXAnalyzeImmediate::ReplaceADDiuSHLWithLUi(InstSeq &Seq) {
